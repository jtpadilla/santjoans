  ...
  return (
    <>
      ...
      <section className="presentation-block">
        ...
        <p>在贵族大厅的前厅，地面上有一幅瓷砖拼成的祭坛画，已缺失若干块，画中人物很可能是<a href="http://es.wikipedia.org/wiki/Luis_Bertr%C3%A1n" target="_blank" rel="noreferrer">圣路易斯·贝尔特兰</a>（San Luis Beltrán）。画的一侧可以看到一个<span className="presentation-link" onClick={() => showPortrait('./presentation/indio.png')}>祈祷中的印第安人</span>。</p>
